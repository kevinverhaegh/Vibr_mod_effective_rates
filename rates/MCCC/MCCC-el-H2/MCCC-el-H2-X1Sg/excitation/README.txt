MCCC calculations of electron scattering on molecular hydrogen.
...
- File names are in the format:
    MCCC-el-H2-[f]_[final vib. state].[i]_[initial vib. state].txt
  with [f]/[i] = final/initial electronic state.
  E.g. MCCC-H2-B1Su_vf=5.X1Sg_vi=0.txt

- In addition to the fully vibrationally resolved transitions, there are files named as follows:
    MCCC-H2-[f]_bound.X1Sg_vi=0.txt     (sum over final bound vibrational levels)
    MCCC-H2-[f]_DE.X1Sg_vi=0.txt        (dissociative excitation)
    MCCC-H2-[f]_total.X1Sg_vi=0.txt     (sum over all final vibrational levels)
